import { readInt32, readUint8, readCString } from './serialization'

// References:
// - https://postgresql.org/docs/current/protocol-error-fields.html
// - https://postgresql.org/docs/current/errcodes-appendix.html

export class PostgresErrorOrNotice<S extends string> extends Error {
   name = 'PostgresErrorOrNotice'
   ...
   readonly severity!: S
   readonly severityLocalized?: string
   ...
   constructor(data: Buffer) {
      ...
      while (offset < msgSize) {
         ...
         case ErrorResponseType.Code:              this.code              = value as PostgresErrorCode ; break
         ...
         case ErrorResponseType.Severity:          this.severity          = value as S                 ; break
...
export class PostgresError extends PostgresErrorOrNotice<'ERROR' | 'FATAL' | 'PANIC'> {
   readonly name = 'PostgresError' as const
}

export class PostgresNotice extends PostgresErrorOrNotice<'WARNING' | 'NOTICE' | 'DEBUG' | 'INFO' | 'LOG'> {
   readonly name = 'PostgresNotice' as const
}
